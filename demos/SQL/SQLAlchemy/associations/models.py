...
class Project(db.Model):
    """Project. Employees can be assigned to projects."""
...
# Inner join only including employees that have a department
...
# Inner join (BY CLASS) only including employees that have a department
...
# Outer join including employees with no department
